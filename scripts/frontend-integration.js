 ...
 * This file demonstrates how to integrate Raftnexus with a web frontend
 */

// For React/Vue/Angular applications
export class RaftnexusClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new RaftnexusClient(provider, contractAddress);
